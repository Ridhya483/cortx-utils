...
ACCESS_KEY="75OVK6G31VQ58Z9LUA18"
SECRET_KEY="jzMs8t6K11PQRuiGYwINCD6Zi5rxW5u90rc12KwB"
#echo $ACCESS_KEY
#echo $SECRET_KEY
...
ENDPOINT="http://192.168.49.6:8000,http://192.168.48.74:8000,http://192.168.49.5:8000"
#echo $ENDPOINT
...
OBJ_SIZE=("4Kb" "1Mb" "4Mb" "64Mb" "128Mb")
SAMPLES=(9999 9999 9999 9999 5000)
CLIENTS=(30 30 30 30 30)
LOOP_COUNT=5
ARR_SIZE=${#OBJ_SIZE[*]}
